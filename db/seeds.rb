...
r_username.each do |username|
  User.create(:username => username, :biography => Faker::Lorem.paragraph, :email => Faker::Internet.email, :password => "testtest", :password_confirmation => "testtest", :email => Faker::Internet.email  )
end
